...
import org.dimatech.model.UploadFileResponse;
...
import org.dimatech.service.FileStorageService;
...
public class FileController {
    ...
    public UploadFileResponse uploadFile(@RequestParam("file") MultipartFile file) {
        ...
        String fileDownloadUri = ServletUriComponentsBuilder.fromCurrentContextPath()
                .path("/uploads/" + user.getId() + "/profilePic/")
                .path(fileName)
                .toUriString();
    ...
    @GetMapping("/uploads/{id}/profilePic/{fileName:.+}")
